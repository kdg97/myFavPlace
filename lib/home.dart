        ...
        Column(
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  myButton(categories[0], Color.fromARGB(255, 58, 94, 183),
                      Colors.white),
                  myButton(categories[1], Colors.white, Colors.black),
            ...
            Expanded(
              child: places.length == 0
                  ? Center(
                      ...
                      children: [
                        Text(
                          "Aucun lieux enregistrés",
                          style: TextStyle(fontSize: 24, color: Colors.black),
                        ),
                        Image(
                          image: AssetImage("assets/images/liste.png"),
                          width: 400,
                          height: 250,
                        )
                      ],
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              "${GetTimeAgo.parse(DateTime.fromMillisecondsSinceEpoch(places[index].timestamps))}",
                                              style: TextStyle(
                                    ...
                                    TextButton(
                                        onPressed: () async {
                                          final checker = await MapLauncher.isMapAvailable(MapType.google);
                                          if ( checker != null && checker ) {
                                          await MapLauncher.showMarker(
                                          mapType: MapType.google,
                                          coords: Coords(places[index].longitude,
                                              places[index].longitude),
                                          title: places[index].name,
                                          description: places[index].desc,
                                          );
                                          }
                                        },
                                        child: Row(
         ...
         FlutterMap(
             ...
             children: [
               TileLayer( // Display map tiles from any source
                ...
                MarkerLayer(markers:[
                  for(var i in places)
                 Marker(point: LatLng(i.latitude, i.longitude),
                     height: 60,
                     width: 300,
